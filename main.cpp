...
int main(int argc, char** argv) {
   ...
   // QGuiApplication::setAttribute(Qt::AA_ShareOpenGLContexts);
    ...
    qputenv("QTWEBENGINE_CHROMIUM_FLAGS", chromiumFlags + " --simulate-touch-screen-with-mouse --touch-events=enabled --enable-features=OverlayScrollbar,kEnableQuic,OverlayScrollbarFlashAfterAnyScrollUpdate,OverlayScrollbarFlashWhenMouseEnter --enable-blink-features=NeverSlowMode,BackFowardCache,CanvasHDR,CompositeBGColorAnimation,CompositeBoxShadowAnimation,CanvasImageSmoothing,Canvas2dScrollPathIntoView,BackForwardCacheExperimentHTTPHeader,Accelerated2dCanvas,AcceleratedSmallCanvases --enable-smooth-scrolling  --disable-low-res-tiling --enable-gpu --enable-gpu-rasterization --enable-zero-copy  --adaboost --enable-gpu-memory-buffer-video-frames  --font-render-hinting=none --disable-font-subpixel-positioning --disable-new-content-rendering-timeout   --enable-defer-all-script-without-optimization-hints --gles-egl --disable-frame-rate-limit --enable-gpu-vsync  --enable-oop-rasterization --enable-accelerated-video-decode --use-angle=gles --enable-es3-apis --enable-accelerated-2d-canvas");
